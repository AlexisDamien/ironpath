...
ThemeData _buildTheme(Brightness brightness) {
  ...
  final textPri   = isDark ? IronColors.darkTextPrimary   : IronColors.lightTextPrimary;
  final textSec   = isDark ? IronColors.darkTextSecondary : IronColors.lightTextSecondary;
  ...
  return ThemeData(
    ...
    textTheme: TextTheme(
      displayLarge:   TextStyle(fontSize: 28, fontWeight: FontWeight.w500, color: textPri, height: 1.2),
      headlineMedium: TextStyle(fontSize: 22, fontWeight: FontWeight.w500, color: textPri, height: 1.3),
      titleMedium:    TextStyle(fontSize: 17, fontWeight: FontWeight.w500, color: textPri, height: 1.4),
      bodyLarge:      TextStyle(fontSize: 15, fontWeight: FontWeight.w400, color: textPri, height: 1.6),
      bodySmall:      TextStyle(fontSize: 13, fontWeight: FontWeight.w400, color: textSec, height: 1.5),
    ),
    ...
    chipTheme: ChipThemeData(
      ...
      labelStyle:        TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: textPri),
      side:              BorderSide(color: border, width: 1),
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(IronRadius.xs),
      ),
      padding: const EdgeInsets.symmetric(horizontal: IronSpacing.sm, vertical: IronSpacing.xs),
    ),
